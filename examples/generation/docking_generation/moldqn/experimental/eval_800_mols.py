...
all_mols = [
    ...
    r"CC[NH+]1CC[C@@H](CNCc2ccc([O-])c[nH+]2)C1",
    r"OC[C@@H](Br)C(F)(F)Br",
    ...
    r"CC[C@@H](O)[C@@]1(C[NH3+])CCC[C@H](C)C1",
    r"OCc1cn2c(n1)OC(Cl)=CC2",
    ...
    r"O=C([O-])c1ccc(CNC(=O)c2cnns2)o1",
    r"C=CCC[C@@H](C)[NH+](C)CCc1nccs1",
    ...
    r"CCOC(=O)C1(C#N)CC(OC)(OC)C1",
    r"[NH3+][C@@H](CSCc1nccs1)C(=O)[O-]",
    ...
    r"CCN(CC)c1ccc(N)c(N)[nH+]1",
    r"C[NH2+]C[C@H]1C[C@H]1c1ccccc1Br",
    ...
    r"Cc1nnc(S[C@H](C)C(=O)N2CCOCC2)n1C",
    r"[NH3+][C@H](Cc1ccc(O)cc1)c1ncccn1",
    ...
    r"O=C([O-])CC1=C(C(=O)[O-])CCCC1",
    r"Cn1cc(C(=O)NCCc2ccccc2)c(C(=O)[O-])n1",
    ...
    r"C[NH2+][C@@H](Cc1csc(C)n1)C(OC)OC",
    r"COc1c(F)cc([C@H]([NH3+])CO)cc1Cl",
    ...
    r"CC[NH+](CC)C[C@H]1CC[NH2+]C1",
    r"C[C@@H]([NH3+])C(=O)N1CC[C@@H](O)C1",
    ...
    r"N#Cc1nn(C(N)=O)c(N)c1C#N",
    r"C[C@H](CNC(=O)N1CCN(S(C)(=O)=O)CC1)N1CCOCC1",
    ...
    r"CC(C)C[NH+](C)CCC(=O)[O-]",
    r"OCc1ccc(CN2CCCC[C@@H]([NH+]3CCCC3)C2)o1",
    ...
    r"N#Cc1ccnc(N2CCC([NH2+]C[C@@H]3CCCO3)CC2)c1",
    r"[NH3+]CC(=O)c1ccc(F)cc1",
    ...
    r"O[C@H]1CCC2C1C1CC[C@H](O)C21",
    r"CCc1nn(C)c(C(=O)NC[C@@H](CC)CCO)c1N",
    ...
    r"O=C([O-])CCNC(=O)N[C@@H]1CCOC1",
    r"O=C([O-])COCCNC(=O)[C@@H]1CCCCO1",
    ...
    r"O=C(Nc1cccnc1)C1=CC=CN2CCS(=O)(=O)N=C12",
    r"CCn1ncc(C[NH2+]C)c1C1CC1",
    ...
    r"C[C@H]1OCC[C@H]1C(=O)NCc1noc(C(C)(C)C)n1",
    ...
    r"O=c1[nH]nc([O-])n1/N=C/c1ccco1",
    r"N#CCCCNC(=O)[C@H]1CC[C@H](C[NH3+])O1",
    ...
    r"COCCC(=O)NC[C@@H]1CC[C@@H](C(=O)[O-])O1",
    r"C#CCNCC(=O)NC[C@@H](C)CO",
    ...
    r"C[C@H]1CC(N)=C(C#N)C1(C#N)C#N",
    r"CCC[NH2+]CC[NH+](C)CC(C)(C)O",
    ...
    r"CCOC[C@H](O)CSC1COC1",
    r"CCn1nc(C)c(Cl)c1C[NH2+]CC1(C)COC1",
    ...
    r"CC[NH+](CC)[C@@](C)(CC)[C@@H](C)O",
    r"CCc1cc(Cn2cc(N)nn2)n(C)n1",
    ...
    r"Cn1ncc(SCC(=O)[O-])c(Cl)c1=O",
    r"Cc1ccc([C@@]23CCC(=O)N2CCC[NH2+]3)cc1",
    ...
    r"CCCC(=O)N[C@@H]1CCC[NH+](Cc2ncccc2C)C1",
    r"COC[C@](C)(O)C1(C#N)CCCC1",
    ...
    r"CC[C@H](C)N1CCN(C(=O)CC(=O)[O-])CC1",
    r"COC(=O)[C@H](C#N)C(F)(F)F",
    ...
    r"CCC(CC)[S@](=O)CCC(=O)[O-]",
    r"CCOCCCc1cnc(C[NH2+]C)o1",
    ...
    r"NC1=C(N)C(=O)c2ncccc2C1=O",
    r"CC(C)[C@@H](NC(=O)[C@H]1CCCO1)C(=O)[O-]",
    r"CCc1csc([C@H]2CCC[NH+](CC(=O)N(C)OC)C2)n1",
    r"CC(C)c1ccc(CNC(N)=[NH2+])cc1",
    r"Cc1cc(F)cc(S(=O)(=O)N(C)CC[NH+](C)C)c1",
    ...
    r"COCC[C@]1(C)O[C@]1(C(=O)OC)C(C)C",
    r"CCn1c(CC2CC[NH2+]CC2)nn(CCO)c1=O",
    ...
    r"COCCOc1cccc(C[NH+]2CCC2(C)C)c1",
    r"Cc1ccc([C@@H](C)NC2=[NH+]CCC2)cc1",
    r"CC(C)NC(=O)NC(=O)[C@@H](C)N1CC[NH+](CCc2ccccc2)CC1",
    r"CC(C)[C@@H](C[NH+](C)C)C(=O)[O-]",
    r"CN1C[NH+](C)CC2=C1NCNS2(=O)=O",
