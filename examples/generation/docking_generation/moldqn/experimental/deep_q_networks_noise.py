...
class DeepQNetwork(object):
    ...
    def __init__(
        ...
        Args:
          ...
          q_fn: A function, whose input is the observation features, and the output
            is the Q value of the observation.
    ...
    def _build_graph(self):
        ...
        with tf.variable_scope(self.scope, reuse=self.reuse):
            ...
            self.action = tf.argmax(q_values)
...
class DeepQNetworkL2(DeepQNetwork):
    """L2 loss DQN."""
